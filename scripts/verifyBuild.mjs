...
try {
  ...
  assert.equal((await fetch(`${baseUrl}/api/missing-smoke`)).status, 404);
  console.log(`Compiled HTTP smoke passed: ${info.version}, ${assets.length} assets, runtime HTML and API 404.`);
} finally {
