...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  DELIVERY_CONFIGURATION_INVALID: 'Confira os dados do modelo de entrega antes de salvar.',
  DELIVERY_NEIGHBORHOOD_DUPLICATE: 'Não cadastre o mesmo bairro mais de uma vez.',
  DELIVERY_NEIGHBORHOOD_REQUIRED: 'Cadastre pelo menos um bairro ativo antes de habilitar a entrega.',
