CREATE OR REPLACE FUNCTION public.create_zelo_order(p_session_id uuid, p_expected_revision integer, p_idempotency_key text, p_snapshots jsonb, p_pessoa_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
