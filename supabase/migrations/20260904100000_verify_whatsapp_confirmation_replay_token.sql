-- ZM2 finding 2: idempotent confirmation replay must still prove possession
-- of the token issued for the same tenant/conversation/session revision.
-- This replaces the function without changing its signature.
